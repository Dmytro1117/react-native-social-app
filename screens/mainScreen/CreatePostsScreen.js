    ...
    <>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          />
          <Text style={styles.header.title}>Создать публикацию</Text>
        </View>
          ...
          {photo ? (
            <>
              ...
              >
                ...
                >
                  <MaterialIcons name="photo-camera" size={34} color="#fff" />
                </TouchableOpacity>
              </ImageBackground>
            </>
          ) : (
            <TouchableOpacity
              ...
              onPress={() => pickImage()}
            >
              <MaterialIcons name="photo-camera" size={34} color="#BDBDBD" />
            </TouchableOpacity>
          )}
        </View>
        ...
        {photo && comment && locationText ? (
          ...
          >
            <Text style={styles.publishPostBtn.title}>Опубликовать</Text>
          </TouchableOpacity>
        ) : (
          <TouchableOpacity
